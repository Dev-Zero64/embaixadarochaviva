            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-12">
                    {historyEvents.map((event, index) => (
                        <div key={index} className="flex flex-col md:flex-row items-center md:items-start md:space-x-8">
                            ...
                            <div className="md:w-2/3 mt-6 md:mt-0">
                                <h2 className="text-2xl font-bold text-church-primary mb-4">{event.year}</h2>
